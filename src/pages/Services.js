...
const Services = () => {
  ...
  const fetchServices = async () => {
    try {
      const response = await axios.get("https://surakshabackend-production-7967.up.railway.app/api/services");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://surakshabackend-production-7967.up.railway.app/api/appointments", {
        ...formData,
